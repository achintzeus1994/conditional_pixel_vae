...
#       print(len(z), z[1].shape, z[0].shape)
        part0 = self.value_calc(z[1], G.t(), nu1[0].unsqueeze(1), nu2[0].unsqueeze(1), 0, -1).sum(dim=1)
        part1 = self.value_calc(z[0], G, nu1[1].unsqueeze(1), nu2[1].unsqueeze(1), 0, -1).sum(dim=1)
        res = (part0 + part1) * 0.5
